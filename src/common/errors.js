...
export const ERROR_DICTIONARY = Object.freeze({
  ...
  INVALID_STATE: { statusCode: 400, code: 'INVALID_STATE', message: CONST.INVALID_STATE },
  FILE_REQUIRED: { statusCode: 400, code: 'FILE_REQUIRED', message: CONST.FILE_REQUIRED },
  FILE_TYPE_NOT_ALLOWED: { statusCode: 400, code: 'FILE_TYPE_NOT_ALLOWED', message: CONST.FILE_TYPE_NOT_ALLOWED },
  FILE_TOO_LARGE: { statusCode: 400, code: 'FILE_TOO_LARGE', message: CONST.FILE_TOO_LARGE },
  INVALID_FIELD_NAME: { statusCode: 400, code: 'INVALID_FIELD_NAME', message: CONST.INVALID_FIELD_NAME },
  DOCUMENT_TYPE_INVALID: { statusCode: 400, code: 'DOCUMENT_TYPE_INVALID', message: CONST.DOCUMENT_TYPE_INVALID },
  FILE_SAVE_ERROR: { statusCode: 500, code: 'FILE_SAVE_ERROR', message: CONST.FILE_SAVE_ERROR },
